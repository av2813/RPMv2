...
"""
Test code initialises a lattice, plots it, reverses the spins stated by 'matrix.npy' which is generated via the minesweeper gui, 
then graphs an 'after' version of the lattice
